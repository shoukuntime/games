...
const I18N = {
    "zh-TW": {
        ...
        "lobby.copy": "複製",
        "lobby.copied": "已複製！",
        "lobby.public_hint": "🌐 公開房間 — 其他玩家可在大廳加入",
        "lobby.private_hint": "🔒 私人房間 — 將代碼分享給朋友",
        "lobby.players": "位玩家",
        "lobby.min": "至少",
        "lobby.start": "開始遊戲",
        "lobby.wait": "等待房主開始遊戲...",
    ...
    "en": {
        ...
        "lobby.copy": "Copy",
        "lobby.copied": "Copied!",
        "lobby.public_hint": "🌐 Public — anyone can join from the lobby",
        "lobby.private_hint": "🔒 Private — share the code with friends",
    ...
    "ja": {
        ...
        "lobby.copy": "コピー",
        "lobby.copied": "コピー済！",
        "lobby.public_hint": "🌐 公開ルーム — ロビーから参加可能",
        "lobby.private_hint": "🔒 プライベート — コードを友達にシェア",
        "lobby.players": "人",
        "lobby.min": "最低",
        "lobby.start": "ゲーム開始",
